...
public:
    ...
    //this must specify particle file (the tipsyfile)
    //the densfile, hsmoothfile, sigmafile are the 
    //binary files generated by "smooth" (converted by
    //the converter)
    DataReader(
        string partfile,
        string densfile,
    ...
    //OBSOLATE: use other constructor
    //to use this reader to read the XDR file
...
private:
    ...
    //the number of DarkMatter particles
